document.addEventListener('DOMContentLoaded', function () {
    ...
    function applyStyles() {
        ...
        // Apply appropriate font size based on screen width
        if (window.innerWidth < 1024) {
            quoteElement.style.fontSize = '30px';
            quoteElement.style.wordBreak = 'break-word';
            quoteElement.style.paddingLeft = '29px';
            quoteElement.style.paddingRight = '29px';
